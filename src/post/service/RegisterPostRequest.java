...
public class RegisterPostRequest {
	...
	public RegisterPostRequest(Board board, Category cate, Writer writer, String postImage, String postTitle,
			String postContent, boolean postVisibility,String postTag) {
		this.board = board;
		this.cate = cate;
		this.writer = writer;
